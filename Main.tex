...
\vspace{1cm}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale=0.8]{images/Nerea/1_concept_art.jpg}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale=1]{images/Nerea/Nerea Zelda concept 111.PNG}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale=1]{images/Nerea/Nerea Zelda concept 121.PNG}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale=1]{images/Nerea/Nerea Zelda concept 122.PNG}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale=1]{images/Nerea/Nerea Zelda concept 123.PNG}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale=1]{images/Nerea/Nerea Zelda concept 124.PNG}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale=1]{images/Nerea/Nerea Zelda concept 131.PNG}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale=1]{images/Nerea/Nerea Zelda concept 132.PNG}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale=1]{images/Nerea/Nerea Zelda concept 133.PNG}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale=1]{images/Nerea/Nerea Zelda concept 141.PNG}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale=1]{images/Nerea/Nerea Zelda concept 142.PNG}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale=1]{images/Nerea/Nerea Zelda concept 143.PNG}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale=1]{images/Nerea/Nerea Zelda concept 144.PNG}
...
%-----------------------------------------------------------------
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale=0.8]{images/Saúl/Sección 3/EA_img3_0Main.png}
...
\subsection{12. Carlos}
  ...
  En esta ocasión la línea del horizonte se encuentra en la parte superior de la imagen, por ese motivo vemos que el arte está en vista de pájaro. Debido a que los elementos del arte son orgánicos, no se aprecian unos puntos de fuga claros.
          ...
          \begin{figure}[H]
    \centering
    \includegraphics[scale=0.35]{images/Carlos/12/Separación.jpg}
    \caption{\small 11. 2/3}
  \end{figure}
...
\subsection{14. Selena (Segunda imagen)}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale=0.35]{images/Selena/14 puntos de interesex.jpg}
...
\subsection{15. Carlos (Segunda Imagen)}
    ...
    La línea del horizonte de esta imagen está situada en el centro de la misma. Es por eso que nos encontramos ante una vista serena. En la luz que entra desde la derecha se aprecia un punto de fuga que se encuentra fuera de la imagen. Pese a que el altar en el que está situada la espada tiene una forma triangular, el polígono no es regular y no se pueden tirar unas líneas de punto de fuga concretas. En el resto de elementos orgánicos tampoco.
            ...
            \begin{figure}[H]
      \centering
      \includegraphics[scale=0.35]{images/Carlos/15/Separación.jpg}
      \caption{\small 11. 2/3}
    \end{figure}
...
\begin{figure}[H]
       \centering
       \includegraphics[scale=0.35]{images/Carlos/15/Constrastes.jpg}
       \caption{\small 11. Contrastes}
    \end{figure}
