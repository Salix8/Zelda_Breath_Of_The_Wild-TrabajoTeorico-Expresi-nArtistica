...
\hypersetup{
    ...
    filecolor=magenta,
    urlcolor=cyan,
    pdftitle={The Legend of Zelda: Breath of the Wild},
...
%-----------------------------------------------------------------
    ...
    La línea de horizonte se halla en medio de la imagen, esto es sabido por la posición de Link y de la isla a la que está el mismo situado, por lo tanto, podemos discernir que se trata de una vista serena.
